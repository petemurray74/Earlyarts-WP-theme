...
foreach ($this->catlist->get_categories_posts() as $single):
    ...
    $lcp_display_output .= '<div class="lcp_article">';

	//$lcp_display_output .= $this->get_date($single). '<br>';
	
	//$lcp_display_output .= $this->get_excerpt($single);
	
    //Show the title and link to the post:    
	$lcp_display_output .= $this->get_post_title($single,'p','lcp_post_title_no_space');

    //Show comments:
    //$lcp_display_output .= $this->get_comments($single);
	$lcp_display_output .= $this->get_content($single,'div','testimonial');
    //Show date:
