	...
	if(!is_user_logged_in()) {
		...
		<div id='membership-wrapper'>
			<form class="form-membership" action="<?php echo get_permalink(); ?>" method="post">
				<fieldset>
				<?php // echo __('Your Subscriptions','membership'); ?>
		...
		if(!current_user_has_subscription()) {
			...
			?>
				<div id='membership-wrapper'>
					...
					<p>We'll send you a reminder when your subscription is due for renewal. In the meantime, sit back relax and enjoy your time with Earlyarts!</p>
					<div class="priceboxes">
					<?php
						...
						foreach( (array) $rels as $rel ) {
							...
							?>
								...
								if( $upgradedat <= strtotime('-' . $period . ' days') ) {
									// Show upgrades
									// Removed the 'upgrade from' message from below -PETE 06-11-2013 
									// look in original renew.form.php to get the original back
									?>
									<?php
