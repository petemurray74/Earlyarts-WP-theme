...
function reactor_register_sidebars() {
	...
	if ( in_array( 'primary', $sidebars[0] ) ) {
		register_sidebar( array( 
			...
			'id'            => 'sidebar',
			'description'   => 'Widgets specific to this section',
			'class'         => '',
	...
	if ( in_array( 'primary-generic', $sidebars[0] ) ) {	
		register_sidebar( array( 
			'name'          => __('Primary Generic', 'reactor'),
			'id'            => 'primary-generic',
			'description'   => 'Displays widgets on most pages',
			'class'         => '',
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h4 class="widget-title">',
	...
	if ( in_array( 'secondary', $sidebars[0] ) ) {	
		register_sidebar( array( 
			'name'          => __('Generic Secondary Sidebar', 'reactor'),
			'id'            => 'sidebar-2',
			'description'   => 'Displays widgets on 3-col pages',
			'class'         => '',
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h4 class="widget-title">',
